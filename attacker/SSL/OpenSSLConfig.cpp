...
int OpenSSLConfig::initOpensslPath(int control) {
	...
	ret = delFolder((char*)(gOpensslPath + "demoCA/").c_str());
	...
	HANDLE hf = CreateFileA((gOpensslPath + "demoCA/index.txt").c_str(), GENERIC_WRITE, 0, 0, 
	...
	HANDLE hfindexattr = CreateFileA((gOpensslPath + "demoCA/index.txt.attr").c_str(), GENERIC_WRITE,
	...
	hf = CreateFileA((gOpensslPath + OPENSSLCONFIG_FILENAME).c_str(), GENERIC_READ|GENERIC_WRITE, 0, 0,
...
int OpenSSLConfig::delFolder(CHAR* srcpath) {
