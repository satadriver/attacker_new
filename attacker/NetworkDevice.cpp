...
string NetworkDevice::selectNetcard(unsigned long* localIP, unsigned long* netmask, unsigned long* netgateip,
	unsigned char* lplocalmac, int& selectedcard) {
	int	iInterfaceCnt = 0;
...
PIP_ADAPTER_INFO NetworkDevice::ShowNetCardInfo(int* count) {
